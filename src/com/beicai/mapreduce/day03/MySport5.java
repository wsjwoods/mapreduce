 ...
 *
 */
public class MySport5 extends ToolRunner implements Tool{
     ...
     public static void main(String[] args) throws Exception {  	
     	...
     	int status = ToolRunner.run(conf, new MySport5(), arguments);
     	MySport5_1 rr = new MySport5_1();
     	String[] arguments1 = {args[1]+"\\part-r-00000",args[1]+"\\out"};
     	if(status==0)
     		status += rr.run(rr.getConf(), rr, arguments1);
     	System.exit(status);
	}
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(getConf());
     	job.setJobName("my----");
     	//运行
     	job.setJarByClass(MySport5.class);
